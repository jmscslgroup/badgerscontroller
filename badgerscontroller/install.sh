...
echo "=========================="
echo "Installing App badgerscontroller"

# Here is where we perform installation of scripts, services, etc.
echo " - Installing ROS packages for badgerscontroller..."
...
runuser -l $LIBPANDA_USER -c /etc/libpanda.d/apps/badgerscontroller/installRosPackages.sh
